...
def make_back_keyboard(command, project_id):
    return InlineKeyboardMarkup([[InlineKeyboardButton("⬅️ Назад", callback_data=f"{command}_{project_id}")]])
...
def make_settings_keyboard(project_id):
    return InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton("⬅️ Назад", callback_data=f"project_{project_id}")]
                ]
            )
...
def make_add_keyboard(file_type, project_id):
    return InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("⬅️ Назад", callback_data=f"files_{project_id}")]
        ])
