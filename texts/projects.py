...
ADD_TASK_REMIND = "🔔 {teacher_name} добавил(а) новую задачу в {project_name}\nМожете увидеть совместный проект в разделе /projects"
ADD_DEADLINE_SUCCESS = "Добавление дедлайна прошло успешно!"
ADD_DEADLINE_REMIND = "🔔 {teacher_name} добавил(а) новый дедлайн в {project_name}\nМожете увидеть совместный проект в разделе /projects"
PROJECT_NOT_FOUND = "Проект не найден или был удалён"
UPDATE_VKR_FILE_SUCCESS = "✅ Файл ВКР успешно обновлён"
UPDATE_VKR_FILE_SUCCESS_REMIND = "🔔 В проекте {project_name} добавлен новый файл ВКР\nМожете увидеть совместный проект в разделе /projects"
UPDATE_VKR_LINK_SUCCESS = "✅ Ссылка на ВКР успешно обновлена"
ADD_ARTICLE_FILE = "✅ Файл статьи успешно добавлен"
UPDATE_ARTICLE_FILE_SUCCESS_REMIND = "🔔 В проекте {project_name} добавлена новая статья\nМожете увидеть совместный проект в разделе /projects"
ADD_ARTICLE_LINK = "✅ Ссылка на статью успешно добавлена"
ADD_FILE = "✅ Файл успешно добавлен"
ADD_LINK = "✅ Ссылка успешно добавлена"
UPDATE_FILE_SUCCESS_REMIND = "🔔 В проекте {project_name} добавлен новый файл\nМожете увидеть совместный проект в разделе /projects"
...
ENTER_NEW_DEADLINE = "Пожалуйста, укажите дату дедлайна в формате ДД.ММ.ГГГГ\nНапример: 01.01.2000"
ENTER_NEW_DESCRIPTION = "Теперь введите описание к дедлайну"
...
TASK_STATUS_REMIND = """🔔 В проекте {project_name} обновлен статус задачи "{task_name}".\n\nМожете увидеть совместный проект в разделе /projects"""
